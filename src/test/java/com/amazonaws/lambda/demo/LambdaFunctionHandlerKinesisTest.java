 ...
 */
public class LambdaFunctionHandlerKinesisTest {
    ...
    @Test
    public void testLambdaFunctionHandlerKinesis() {
        LambdaFunctionHandlerKinesis handler = new LambdaFunctionHandlerKinesis();
